...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/recipes/_id/index.vue?vue&type=template&id=5e4ddf94&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[(_vm.$fetchState.pending)?_vm._ssrNode("<p>","</p>"):(_vm.$fetchState.error)?_vm._ssrNode(("<p>Error tijdens het laden van de recepten</p>")):_vm._ssrNode("<div>","</div>",[_vm._ssrNode("<div class=\"bg-red-500 rounded-lg h-48\">"+((_vm.recipe_data.image !== null)?("<img"+(_vm._ssrAttr("src",'http://' + _vm.serverUrl + '/' + _vm.recipe_data.image))+" alt class=\"w-full h-48 object-cover rounded-lg opacity-100\">"):"<!---->")+"</div> "),_vm._ssrNode("<div class=\"py-2 mb-4\">","</div>",[_vm._ssrNode("<div class=\"flex items-center\">","</div>",[_vm._ssrNode("<p class=\"text-2xl inline-block\">"+_vm._ssrEscape(_vm._s(_vm.recipe_data.title))+"</p> "),_c('nuxt-link',{staticClass:" hover:text-red-500 focus:outline-none  mt-1 ml-4",attrs:{"to":'/recipes/' + _vm.recipe_id + '/edit'}},[_c('fa-layers',{staticClass:"fa inline-block"},[_c('fa',{attrs:{"icon":"pen"}})],1)],1)],2),_vm._ssrNode(" "+((_vm.recipe_data.source)?("<p class=\"text-sm text-gray-600\">"+_vm._ssrEscape("\n        bron: "+_vm._s(_vm.recipe_data.source)+"\n      ")+"</p>"):"<!---->"))],2),_vm._ssrNode(" <div class=\"md:flex\"><div class=\"py-2 md:flex-shrink md:mr-12 md:max-w-p40\"><p class=\"text-lg font-bold\">Ingredienten</p> <table class=\"table-auto\"><tbody>"+(_vm._ssrList((_vm.recipe_data.ingredient),function(ingredient,idx){return ("<tr><td nowrap=\"nowrap\" class=\"align-top\">"+_vm._ssrEscape("\n                "+_vm._s(ingredient.quantity)+" "+_vm._s(ingredient.unit)+"\n              ")+"</td> <td class=\"px-4\">"+_vm._ssrEscape(_vm._s(ingredient.ingredient))+"</td></tr>")}))+"</tbody></table></div> <div class=\"py-2 md:flex-grow\">"+(_vm._ssrList((_vm.recipe_data.instruction),function(instruction){return ("<div class=\"pb-2 mb-4 w-full border-b-2 border-gray-300\"><p class=\"text-lg font-bold\">"+_vm._ssrEscape("\n            Stap "+_vm._s(Number(instruction.step) + 1)+"\n          ")+"</p> <p class=\"text-sm\">"+_vm._ssrEscape(_vm._s(instruction.instruction))+"</p></div>")}))+"</div></div>")],2)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/recipes/_id/index.vue?vue&type=template&id=5e4ddf94&
