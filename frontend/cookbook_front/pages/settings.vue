<template>
  <div>
      ...
      <div class="flex content-center">
        ...
        <button class=" bg-gray-300  px-3 h-10 focus:outline-none hover:bg-red-500 transition duration-300 ease-in-out" @click="addTag" >Voeg toe</button>
      </div>
      <div class="py-4 flex flex-wrap">
        <div v-for="tag in tags" v-bind:key="tag.id" class="rounded-lg bg-gray-300 p-2 mr-2 mb-2">
          {{ tag.name }}
        </div>
      </div>
      </div>
